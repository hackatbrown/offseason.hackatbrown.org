export default function Footer() {
  ...
  return (
    <footer className="absolute inset-x-0 bottom-0 z-30 bg-gradient-to-t from-purple from-40% to-transparent px-4 pb-2 pt-4 sm:px-6 sm:pb-2.5 flex items-end justify-between gap-4">
      ...
      <p className={textClass}>
        {"prev: "}
        <a href="https://2026.hackatbrown.org" className={linkClass} target="_blank" rel="noopener noreferrer">
          Hack@Brown 2026
        </a>
      </p>
    </footer>
